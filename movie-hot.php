<div id="movie-hot" class="viewport">
  ...
  <ul class="listfilm overview owl-carousel owl-theme">
    ...
    ?>
      <li class="item">
        <a href="?mod=detail&film_id=<?php echo $r['id'] ?>" title="<?php echo $r['name'] ?>" class="movie-hot-link" style="background-image: url(<?php echo $r['image'] ?>);"></a>
        <div class="overlay">
          <div class="name">
            <a href="?mod=detail&film_id=<?php echo $r['id'] ?>" title="<?php echo $r['name'] ?>"><?php echo $r['name'] ?></a>
          </div>
